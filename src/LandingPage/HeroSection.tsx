    ...
    <section className="relative flex flex-col items-center justify-center min-h-[60vh] bg-gradient-to-br from-blue-200 to-blue-400 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-4 py-20">
        ...
        <div className="flex flex-col gap-4 md:flex-row">
          <button className="px-8 py-4 text-xl font-semibold text-white transition border border-white rounded-lg shadow bg-gradient-to-r from-white/10 via-white/0 to-white/10 hover:bg-white/20">Watch Video</button>
          <button className="px-8 py-4 text-xl font-semibold text-white transition rounded-lg shadow bg-gradient-to-r from-blue-900 via-blue-900 to-cyan-900 hover:from-blue-800 hover:to-cyan-300">Get Started</button>
        </div>
      </div>
    </section>
  );
